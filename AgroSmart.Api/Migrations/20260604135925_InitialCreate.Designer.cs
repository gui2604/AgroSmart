...
namespace AgroSmart.Api.Migrations
{
    ...
    [Migration("20260604135925_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgroSmart.Api.Models.Alert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("AgroSmart.Api.Models.AlertRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.ToTable("AGS_ALERT_RULES", (string)null);
                });

            modelBuilder.Entity("AgroSmart.Api.Models.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.ToTable("AGS_DEVICES", (string)null);
                });

            modelBuilder.Entity("AgroSmart.Api.Models.Measurement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("AgroSmart.Api.Models.MetricType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("AgroSmart.Api.Models.Region", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("AgroSmart.Api.Models.SensorReading", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("AgroSmart.Api.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("AgroSmart.Api.Models.Alert", b =>
                {
                    b.HasOne("AgroSmart.Api.Models.User", "AcknowledgedByUser")
